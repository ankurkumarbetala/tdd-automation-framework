...
public class ScreenRecorderUtil extends ScreenRecorder {
	...
	public static ThreadLocal<ScreenRecorder> screenRecorder = new ThreadLocal<ScreenRecorder>();
	public String name;
	...
	public static void startRecord(String methodName) throws Exception {
		String path = System.getProperty("user.dir") + "//src//test//resources//test-recordings//"
		...
		screenRecorder.set(new ScreenRecorderUtil(gc, captureSize,
